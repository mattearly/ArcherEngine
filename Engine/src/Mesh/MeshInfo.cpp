...
MeshInfo::MeshInfo(unsigned int a, unsigned int elcount, TextureMapType t_id, glm::mat4 trans)
  : vao(a), numElements(elcount), textureDrawIds(t_id), local_transform(trans) {
}

MeshInfo::MeshInfo(unsigned int a, unsigned int elcount, TextureMapType t_id, Material mat, glm::mat4 trans)
