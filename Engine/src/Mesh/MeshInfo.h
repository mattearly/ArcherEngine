...
struct MeshInfo {
  ...
  MeshInfo(unsigned int a, unsigned int elcount, TextureMapType t_id, glm::mat4 local_trans);
  MeshInfo(unsigned int a, unsigned int elcount, TextureMapType t_id, Material mat, glm::mat4 local_trans);
  unsigned int vao = 0;
